<?php
/*
Template Name: List fullwidth filterable
...
if( $adtop ) { ?>
<div class="container"><div class="adinpage_wrap_full"><?php echo $adtop; ?></div></div>
<?php } ?>
<!-- 
///////////////////
///Breakcrumbs ///
...
//////////// 
-->
<?php if($slogan){ ?><div class="container"><div class="slogn_full"><?php echo $slogan; ?></div></div><?php } else{} ?>
<!-- 
///////////////////
///Start slider///
//////////////////
...
<div class="slidew">
	...
	<?php $args = array(
		...
		$attachments = get_posts( $args );
			foreach ( $attachments as $attachment ) {
				$src = wp_get_attachment_image_src( $attachment->ID, 'slide' );
	?>
				<li>
...
if( $adfrontmiddle ) { ?>
	<div class="container"><div class="adinpage_wrap_full"><?php echo $adfrontmiddle; ?></div></div>
<?php } ?>
<!-- 
///////////////////
///Quote slogan///
//////////////////
-->
<?php if ($quote) {?><div class="container"><div class="quote_full"><?php echo $quote;?></div></div><?php }else{}?>
...
-->
	...
	if ($layoutinlist=='One Image Layout A') { ?>
		...
		if ( $attachments ) {
			...
			?>
			<li>
			<?php if($idi_lightbox == "true") { ?><a href="<?php echo $ImageUrl[0];?>" title="<?php the_title(); ?>" class="imgwrap" rel="prettyPhoto[]"><div class="back"><div class="backbg"></div><div class="icoimage"></div></div><?php echo $Img; ?></a>
			<?php }else{ ?>
			<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php echo $Img; ?></a>
			<?php } ?>
			</li>
...
/////////-->
<?php if( $adbottom ) { ?>
	<div class="container"><div class="adinpage_wrap_full"><?php echo $adbottom; ?></div></div>
<?php } ?>
<?php get_footer(); ?>