// hack css IE 
	...
	jQuery(document).ready(function() {	
		...
		jQuery(".clum2_sidebar_unit .widget_uxsocialinons li:nth-child(4n)").css("margin-right","0");
		jQuery("ul.flickrarea").css("margin-left","0px");
		jQuery("ul.flickrarea li:nth-child(2n)").css("margin-right","0px");
